...
export function PortfolioBento() {
  return (
    <section className="relative flex w-full flex-col items-center overflow-clip">
     <div className="container flex flex-col items-end justify-center gap-4 px-20 pb-20 pt-12">
      <ArrowLink
        href="#"
        icon="/images/home/arrow-icon-view-all.svg"
        iconSize={14}
      ...
      <div className="relative h-[500px] w-[1280px] shrink-0 overflow-clip">
        <div className="absolute left-0 top-0 flex w-[1280px] items-center justify-between">
          <div className="relative flex h-[500px] w-[388px] shrink-0 flex-col items-center justify-end overflow-clip rounded-xl px-[25px] py-8">
            <div className="pointer-events-none absolute inset-0 overflow-hidden rounded-xl">
              ...
              <img
                ...
                className="absolute left-[-78.31%] top-[0.01%] h-full w-[193.28%] max-w-none"
            ...
            <div className="relative flex w-full shrink-0 flex-col items-start gap-2.5 rounded-[9px] bg-white px-3.5 py-4 drop-shadow-[0px_4px_3px_rgba(0,0,0,0.1),0px_2px_2px_rgba(0,0,0,0.06)]">
              <p className="w-[119px] font-serif-display text-xl font-normal not-italic leading-[22px] text-black">
                Project Name
              </p>
              <p className="w-full min-w-full font-sans text-sm font-normal leading-[18px] text-black">
                Non officia ullamco aute sit nulla ea magna ullamco.
              </p>
              <div className="flex w-full shrink-0 items-center justify-end gap-2.5 border-t border-light-green-cta pt-3">
                <ArrowLink
                  href="#"
                  icon="/images/home/arrow-icon-view-project.svg"
                  iconSize={14}
          ...
          <div className="grid h-[500px] w-[857px] shrink-0 grid-cols-2 grid-rows-2 gap-8">
            ...
            <div className="col-span-2 relative self-stretch justify-self-stretch rounded-xl">
              <div className="pointer-events-none absolute inset-0 overflow-hidden rounded-xl">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  alt="Hanson Landscape project"
                  className="absolute left-[-0.05%] top-[-59.63%] h-[242.49%] w-full max-w-none"
