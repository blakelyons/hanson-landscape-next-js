...
export function ProcessSection() {
  return (
    <section className="relative flex w-full flex-col items-center justify-center bg-neutral-25 py-20">
     <div className="container relative flex flex-col items-center justify-center gap-12 px-20">
      ...
      <div className="w-[1140px] rounded-xl border border-neutral-200 bg-white px-12 py-10">
        <div className="grid grid-cols-4 items-end gap-x-8">
          {STEPS.map((step) => (
            <div key={`${step.number}-title`} className="flex flex-col items-center gap-2 text-center">
              ...
              <p className="whitespace-nowrap font-sans text-lg font-bold leading-7 text-black">{step.title}</p>
            </div>
          ))}
        </div>
        ...
        <div className="relative mt-10 grid grid-cols-4 items-center gap-x-8">
          ...
          {STEPS.map((step) => (
            <div
              ...
              className="relative z-10 mx-auto flex size-12 shrink-0 flex-col items-center justify-center rounded-full bg-light-green-cta"
            >
              <p className="w-full text-center font-sans text-lg font-bold leading-7 text-black">{step.number}</p>
            </div>
          ))}
        </div>

        <div className="mt-6 grid grid-cols-4 gap-x-8 text-center font-sans text-sm font-normal leading-[18px] text-black">
          {STEPS.map((step) => (
        ...
        <div className="mt-10 flex w-full items-center justify-between gap-8 rounded-xl bg-amber-light px-12 py-[18px]">
          <p className="whitespace-nowrap font-sans text-sm font-semibold leading-[18px] text-black">
          ...
          <PillButton
            ...
            icon="/images/home/arrow-icon-lg-green.svg"
            iconSize={12}
          >
            Get In Touch
          </PillButton>
