        ...
        <section className="relative w-full overflow-clip bg-[#0e2113]">
            <div className="relative container">
                ...
                <div className="pointer-events-none absolute inset-0 overflow-clip">
                    <div className="absolute -top-32 -left-24 size-[600px] max-w-none">
                        <div className="absolute inset-[-32.65%]">
                            {/* eslint-disable-next-line @next/next/no-img-element */}
                            <img alt="" className="block size-full max-w-none" src="/images/home/bg-glow.svg" />
                        </div>
                    </div>
                    <div className="absolute top-0 -right-10 size-[300px] max-w-none opacity-80">
                        {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img
                            alt=""
                    ...
                    <div className="absolute top-[42%] right-[6%] h-[60px] w-[95px] max-w-none rotate-[62deg]">
                        {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img
                            alt=""
                            className="absolute inset-0 block size-full max-w-none"
                    ...
                    <div className="absolute top-[62%] right-[16%] h-[46px] w-[100px] max-w-none -scale-x-100">
                        {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img
                            alt=""
                            className="absolute inset-0 block size-full max-w-none"
                ...
                <div className="relative z-10 flex flex-col items-start gap-3.5 px-[120px] py-16">
                    ...
                    <p className="max-w-[640px] font-sans text-lg leading-[30px] font-normal text-[rgba(250,251,248,0.78)]">
                        {description}
                    </p>
                </div>
            </div>
